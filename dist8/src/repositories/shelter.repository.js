...
let ShelterRepository = class ShelterRepository extends repository_1.DefaultCrudRepository {
    constructor(datasource) {
        super(shelter_model_1.Shelter, datasource);
        this.datasource = datasource;
    }
};
ShelterRepository = __decorate([
